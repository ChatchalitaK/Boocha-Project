...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2025 at 11:32 AM
...
('AA0000070', 'CUS0000003', '2025-05-10 16:13:04', NULL);
...
('AAAA0000078', 'AA0000068', 'MATUJI11', 2, 1940),
('AAAA0000079', 'AA0000069', 'KABUJI20', 1, 820),
('AAAA0000080', 'AA0000070', 'BANKUM20', 2, 1660);
...
('PAY0000068', 'AA0000068', 2020, 'Mobile Banking', 'Pending', '0000-00-00 00:00:00'),
('PAY0000069', 'AA0000069', 900, 'Mobile Banking', 'Pending', '0000-00-00 00:00:00'),
('PAY0000070', 'AA0000070', 1740, 'Mobile Banking', 'Pending', NULL);
...
('BANFUK00', 'Bancha Fukuoka Non-firing Culinary', 'Bancha green tea from Fukuoka, Japan. This non-firing variety offers a rich umami flavor, perfect for culinary applications. Packaged in 150g bags.', 730.00, 139, 'Available', '2023-11-15', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745311972/BANFUK00_lb7fjz.png', 'TT001', 'PV001', 'RL001', 'GR001'),
...
('REP0000001', 'AA0000014', '2023-10-13 19:55:00', 'Damaged Percel', 'The parcel I received was quite damaged, and I noticed multiple tears in the product packaging. The item inside might be affected, so I would like to request a replacement.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313393/REP0000001_s7yqfu.png', 'Accepted'),
('REP0000002', 'AA0000032', '2023-10-24 14:15:00', 'Wrong Item Received', 'I ordered Bancha Mie Low-firing Ceremonial tea, but instead, I received Bancha Uji Low-firing Ceremonial. This is not the product I originally purchased, so I would like to exchange it for the correct one.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312993/REP0000002_vipniw.png', 'Accepted'),
('REP0000003', 'AA0000059', '2023-11-03 16:40:00', 'Not All Item Received', 'I ordered 1 bag of Gyokuro Fukuoka High-firing Culinary tea and 2 bags of Genmaicha Shizuoka Low-firing Ceremonial tea. However, I only received 1 bag of each, missing 1 bag of Genmaicha Shizuoka Low-firing Ceremonial. I would like the missing item to be shipped or a refund for the missing portion.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312704/REP0000003_rogz64.png', 'Accepted');
...
INSERT INTO `review` (`ReviewID`, `CustomerID`, `ProductID`, `Review_Date`, `Comment`, `ReviewImage`) VALUES
('RVW0000001', 'CUS0000003', 'SENSHI20', '2023-10-04 14:30:00', 'This tea powder has such a rich and smooth flavor. Perfect for starting my day!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312586/P1011_nqa0sh.png'),
('RVW0000002', 'CUS0000047', 'MATSHI31', '2023-10-07 10:45:00', 'I love how easy it is to prepare. Just mix with hot water, and it\'s ready to drink!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312587/P3013_relnk3.png'),
('RVW0000003', 'CUS0000047', 'KABMIE31', '2023-10-05 18:20:00', 'The aroma is so refreshing. It instantly lifts my mood.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312587/P6023_wrzmca.png'),
('RVW0000004', 'CUS0000012', 'BANFUK01', '2023-10-06 20:10:00', 'Great for a quick energy boost without the jitters.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312588/P4009_fmgpzv.png'),
('RVW0000005', 'CUS0000029', 'KABUJI21', '2023-10-07 09:15:00', 'The texture is so fine, and it dissolves perfectly in water.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312589/P4014_xkwvwl.png'),
('RVW0000006', 'CUS0000005', 'HOJMIE30', '2023-10-08 19:30:00', 'I enjoy the natural taste without any artificial flavors.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312589/P2017_k1fk8z.png'),
('RVW0000007', 'CUS0000038', 'BANUJI00', '2023-10-05 21:00:00', 'Perfect for making iced tea. Just add some ice and a slice of lemon!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313398/P5009_iz07eh.png'),
('RVW0000008', 'CUS0000017', 'HOJUJI10', '2023-10-09 16:50:00', 'The packaging is convenient and keeps the tea powder fresh.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312964/P5023_e1fciw.png'),
('RVW0000009', 'CUS0000017', 'HOJMIE21', '2023-10-06 11:25:00', 'I love how versatile it is. You can use it for baking or smoothies too!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312587/P2017_1_yaqw2m.png'),
('RVW0000010', 'CUS0000017', 'HOJKUM00', '2023-10-07 08:30:00', 'The flavor is so balanced?not too bitter, not too sweet.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312590/P4021_v2ierd.png'),
('RVW0000011', 'CUS0000042', 'KABMIE20', '2023-10-12 17:40:00', 'It?s my go-to drink when I need to relax after a long day.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312591/P7007_yaqdz3.png'),
('RVW0000012', 'CUS0000009', 'SENUJI10', '2023-10-10 22:00:00', 'The tea powder is so fine; it feels like drinking a cloud!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312591/P4024_pspwxp.png'),
('RVW0000013', 'CUS0000021', 'GYOUJI20', '2023-10-14 12:15:00', 'I appreciate that it\'s made from high-quality ingredients.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312591/P4019_1_wxofr8.png'),
('RVW0000014', 'CUS0000035', 'MATFUK00', '2023-10-27 10:30:00', 'It?s a great alternative to coffee. I feel energized but calm.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312587/P2008_a9ftt2.png'),
('RVW0000015', 'CUS0000014', 'HOJUJI11', '2023-10-25 19:45:00', 'The color of the tea is so vibrant and inviting.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312592/P8007_zx8rxy.png'),
('RVW0000016', 'CUS0000039', 'BANMIE30', '2023-10-26 15:20:00', 'I love how it doesn\'t leave any residue at the bottom of my cup.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312596/P6012_f5i3ih.png'),
('RVW0000017', 'CUS0000020', 'MATUJI21', '2023-10-28 08:45:00', 'It?s so convenient to carry around. I can make tea anywhere!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312590/P4021_v2ierd.png'),
('RVW0000018', 'CUS0000044', 'KABUJI00', '2023-10-24 21:10:00', 'The flavor is so pure and natural. You can tell it?s made with care.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312599/P1007_sle94h.png'),
('RVW0000019', 'CUS0000010', 'SENKUM10', '2023-10-29 14:50:00', 'I?ve been using this tea powder daily, and I feel so much healthier.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312596/P5026_tzooxp.png'),
('RVW0000020', 'CUS0000034', 'GENSHI30', '2023-10-30 18:30:00', 'It?s perfect for making a quick matcha latte. Just add some milk!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312710/P6033_jiuh9w.png'),
('RVW0000021', 'CUS0000005', 'GYOFUK21', '2023-10-31 10:15:00', 'The aroma alone is enough to make me feel relaxed.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312704/P6019_decg2u.png'),
('RVW0000022', 'CUS0000005', 'BANUJI21', '2023-11-02 20:00:00', 'I love how it?s not overly processed. You can taste the authenticity.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312707/P1035_hs2uqn.png'),
('RVW0000023', 'CUS0000023', 'MATSHI21', '2023-11-01 12:30:00', 'It?s my secret ingredient for adding depth to my desserts.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312592/P6022_lxukhu.png'),
('RVW0000024', 'CUS0000047', 'KABMIE10', '2023-11-03 09:45:00', 'The tea powder is so versatile. I use it in both hot and cold drinks.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312705/P4019_urjthl.png'),
('RVW0000025', 'CUS0000012', 'HOJMIE10', '2023-11-02 16:20:00', 'I appreciate that it?s caffeine-free. Perfect for evening relaxation.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312750/P5014_usrnbx.png'),
('RVW0000026', 'CUS0000029', 'SENSHI30', '2023-10-05 13:10:00', 'The flavor is so unique?I?ve never tasted anything like it!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313089/P2006_saurr9.png'),
('RVW0000027', 'CUS0000029', 'FUKSHI30', '2023-10-08 19:45:00', 'It?s so easy to adjust the strength. Just add more or less powder.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313394/P3022_o7bxym.png'),
('RVW0000028', 'CUS0000002', 'GYOFUK01', '2023-10-09 10:20:00', 'I love how it?s packed with antioxidants. Great for my health!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313395/P1005_nxmnow.png'),
('RVW0000029', 'CUS0000012', 'BANFUK01', '2023-10-11 15:30:00', 'The tea powder is so fine; it blends perfectly into my smoothies.', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745313398/P5026_1_aymr30.png'),
('RVW0000030', 'CUS0000035', 'MATFUK00', '2023-10-13 18:40:00', 'It?s become a staple in my pantry. I can?t imagine my day without it!', 'https://res.cloudinary.com/drcyehkac/image/upload/v1745312599/P1007_sle94h.png');
...
('SHI0000067', 'AA0000067', '0000-00-00 00:00:00', 'Preparing'),
('SHI0000068', 'AA0000068', '0000-00-00 00:00:00', 'Preparing'),
('SHI0000069', 'AA0000069', '0000-00-00 00:00:00', 'Preparing'),
...
('CUS0000001', 'meganhamilton', '2a83010dc99b7197', 'Sara', 'Pittman', '89385 Michael Drive, East Raymondstad, DE 06992', '091-234-5678  ', 'ivalentine@herring.org', '2025-01-25 20:27:16', 'Customer'),
...
('CUS0000008', 'fthomas', '704c69d882aea288', 'Leah', 'Ray', '3965 Meyers Fork, Jessicaside, MD 86283', '098-901-2345  ', 'plong@hotmail.com', '2025-03-02 14:07:01', 'Customer'),
...
--
ALTER TABLE `review`
  ADD CONSTRAINT `review_customer` FOREIGN KEY (`CustomerID`) REFERENCES `user` (`UserID`),
  ADD CONSTRAINT `review_product` FOREIGN KEY (`ProductID`) REFERENCES `product` (`ProductID`);
COMMIT;
